...
ProceduralGenerator ProceduralGeneratorFromString(const std::string& s)
{
 ...
 std::cerr << "WARN: unknown procedural.generator '" << s << "', using heightmap" << std::endl;
 return ProceduralGenerator::Heightmap;
}
...
{
 switch (g) {
 case ProceduralGenerator::Flat: return "flat";
 case ProceduralGenerator::Heightmap: return "heightmap";
 case ProceduralGenerator::Overworld: return "overworld";
 case ProceduralGenerator::Hills: return "hills";
 case ProceduralGenerator::Mountains: return "mountains";
 case ProceduralGenerator::OverworldBiomes: return "overworld_biomes";
 case ProceduralGenerator::OverworldFull: return "overworld_full";
 default: return "heightmap";
 }
}
...
VerticalMode VerticalModeFromString(const std::string& s)
{
 ...
 if (s != "compact" && !s.empty()) {
  std::cerr << "WARN: unknown procedural.vertical '" << s << "', using compact" << std::endl;
 }
