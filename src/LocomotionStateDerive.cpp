                                  ...
                                  const CreatureLocomotionRawInput* hintInput)
{
 ...
 const float runThreshold =
     std::max(caps.walkSpeed * locomotion::kRunSpeedFactor, locomotion::kMoveSpeedEpsilon);
 ...
 if (raw.horizontalSpeed > locomotion::kMoveSpeedEpsilon && hintInput && hintInput->hasSuggestedAnim) {
