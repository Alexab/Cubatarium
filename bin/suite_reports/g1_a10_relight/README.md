...
| T2 / N04 | **autopsy SoT `074859`** — stalled~51 schedule≈0 (H2 miss); wrong-tex lag≈413 incomplete=0 |
...
### N04 autopsy I2 decision (autofly `111708`)

| Lane | Evidence | Decision | Next |
|---|---|---|---|
