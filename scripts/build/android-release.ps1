# Build Cubatarium release AAB for store distribution (delegates to platforms/android).
...
if (-not (Test-Path $keystoreProps)) {
    ...
    Write-Host "Release AAB will be unsigned and cannot be uploaded to stores."
}
