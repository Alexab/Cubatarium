...
| G1 | Progress PASS / **product NOT closed** | dual-Q + RemeshQ snapshot (P1) + kick quota (P2) + debt age (P3) + SmallOracle (P4). Progress baseline `210134`. North autofly P5 cold/warm `230002`/`230452` (yaw **90**, VB med **21**) is **not** 174657-class. West manual FAIL `080455`/`080523`: VB med **75**, `focus_missing≈0.94`. Product proxy `product-174657` + **RelightReplace Dirty sole-owner** (`c3010053`): F5 early west VB still ~90–109 (see `g1_a10_relight/`). A10 **partial** (FullyDark secondary Dirty gated). FalseNegCull still 0 until world object-id. Manual eye still required for CLOSED. |
