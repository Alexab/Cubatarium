...
Следующий шаг: dual-lane FirstMesh/RemeshLit schedule contract (remove miss-driven remesh-snapshot defer; lane quotas ≠ Capture/Apply floors); control autofly `product-174657`; west manual eye vs `122212`; object-id FBO (E4). Floors / SoftDefer-for-holes запрещены. `ok_fm≈0` consumer/class remains S5 follow-up.
