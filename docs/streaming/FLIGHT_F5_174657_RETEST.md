...
- **P2 product_anchor:** Release `bin/Cubatarium.exe` rebuilt after P1+Q2b/Q4/Q6 (2026-09-12 ~18:39, sha256 `AC7003B329F8984B…`). **Manual F5 vs 090306 required** before `git tag product_anchor_YYYYMMDD`. Fill **Anchor** column below on PASS.
