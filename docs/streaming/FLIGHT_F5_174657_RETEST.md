...
- **G1 product autofly proxy:** `python tools/flight_sim_run.py --scenario product-174657` (yaw **180**, fly-heavy 20/120/30). Route JSON: `tools/manual_flight_world164_product_174657.json`. Reports: `bin/suite_reports/g1_a10_relight/`.
