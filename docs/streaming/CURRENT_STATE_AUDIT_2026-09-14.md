...
| N04 / sticky mid black | **REOPEN (T2)** | P3 `ada996f9` equal-rev→LegalDark = census greenwash, not heal; SoT manual `204501` (VB~86, legal_dark~84, eye Δ FAIL); G1 OPEN |
...
| S2b / T2 mid FullyDark | **REOPEN** — P3 LegalDark reclass ≠ heal; plan `.cursor/plans/n04_legal_dark_greenwash_fix.plan.md`; SoT `204501` |
...
C1 KEEP; post-N01 P0–P2 thrash cut KEEP; **P3 T2 REOPEN** (LegalDark≠heal).
